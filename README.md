...
We can reduce the data precision by mapping weights to discrete levels, e.g., 1.01, 1.02, 1.99 are set to 2. Using this technique the model can use low bit-width data representation and as a result we can reduce the area and energy cost of the model. 
